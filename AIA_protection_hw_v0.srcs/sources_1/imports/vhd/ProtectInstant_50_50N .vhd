-- =====================================================================
-- Bloco      : ProtectInstant_50_50N
-- Função     : ANSI 50/50N com atraso intencional (ms) e histerese.
...
entity ProtectInstant_50_50N is
  generic (
...
architecture rtl of ProtectInstant_50_50N is
  -- Estados
      ...
      if i_rst = '1' then
        ...
        case r_state is
          ...
          when S_MONITORING =>
            ...
            if i_valid = '1' then
              if unsigned(i_sample_u12) >= unsigned(i_peakup_u12) then
          ...
          when S_ACTIVATED_TIMER =>
            ...
            if i_valid = '1' then
              if unsigned(i_sample_u12) < s_hyst_low then
                r_timer_en <= '0';
                r_state    <= S_MONITORING;
              end if;
            end if;
